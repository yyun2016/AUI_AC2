...
public class LogXmlUpdate {
    ...
    public static void xmlUpdateKey(String filename,String node,String value) {
        ...
        if (root.hasChildNodes()) {
            ...
            for (int i = 0; i < ftpnodes.getLength(); i++) {
               ...
               // System.out.println(ftpnodes.item(i).getTextContent());
                System.out.println();
                ...
                for (int k = 0; k < ftplist.getLength(); k++) {
                    ...
                    if (subnode.getNodeType() == Node.ELEMENT_NODE
                    	...
                    	/*String nodeid= subnode.getAttributes().item(0).getNodeValue();
                    	if (rmid.equals(nodeid)) {
    ...
    public static void main(String args[]) throws Exception {
    	...
    	String fileName= "E:\\ATT\\log\\log.xml";
    	UiBean kBean = new UiBean();
    	kBean.setRandomid("14025624798450_1_1");
    	LogXmlUpdate.testCaseUpdateXml(fileName, "14025624798450_1_1", "LogArgument", "测试你个头");
