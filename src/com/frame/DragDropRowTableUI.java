...
public class DragDropRowTableUI extends BasicTableUI {
    ...
    class DragDropRowMouseInputHandler extends MouseInputHandler {
        ...
        public void mousePressed(MouseEvent e) {
        	...
        	//MainFrame.spTable.getModel().removeTableModelListener(MainFrame.sTableModelListener);
        ...
        public void mouseReleased(MouseEvent e){
        	...
        	draggingRow = false;
        	table.repaint();
        	//MainFrame.spTable.getModel().addTableModelListener(MainFrame.sTableModelListener);
        }
    }
}